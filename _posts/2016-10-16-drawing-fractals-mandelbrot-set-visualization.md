---
layout: default
title: "Drawing Fractals: Mandelbrot Set Visualization"
date: 2016-10-16
---

[![mandelbrot-set](https://smthngsmwhr.files.wordpress.com/2016/10/mandelbrot-set.jpg)](https://smthngsmwhr.files.wordpress.com/2016/10/mandelbrot-set.jpg)
...
[![mandelbrot_sequence](https://smthngsmwhr.files.wordpress.com/2016/10/mandelbrot_sequence.gif)](https://smthngsmwhr.files.wordpress.com/2016/10/mandelbrot_sequence.gif)

is such that their norm does not grow to the infinity as the index *n* increases indefinitely.

If at this point the notions of complex number, operations with complex numbers and computing the norm are not clear, please, refer for more details to the following Wikipedia article [Complex number](https://en.wikipedia.org/wiki/Complex_number) for details.
...
An interesting thing about the Mandelbrot set is that despite the relative simplicity and mathematical formality of the definition, the set itself turns out to be quite curiously looking, as if it were some real thing occurring in nature and in addition to that it also has a property of repeating the same pattern infinitely at every scale. The structures with the property of repeating itself at every scale are called *fractals* [Fractal](https://en.wikipedia.org/wiki/Fractal).
